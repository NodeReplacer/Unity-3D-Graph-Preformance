//Same as GraphGPU.hlsl but with float 4x4 as the positions buffer.
//Also we can directly copy the matrix instead of using a constructor
//like we needed to in GraphGPU.hlsl
